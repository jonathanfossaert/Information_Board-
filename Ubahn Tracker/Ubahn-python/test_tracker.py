...
direction0 = Label(master,font=("Calibri",25),bg="white",fg="black")
direction1 = Label(master,font=("Calibri",25),bg="white",fg="black")
direction2 = Label(master,font=("Calibri",25),bg="white",fg="black")
direction3 = Label(master,font=("Calibri",25),bg="white",fg="black")
direction4 = Label(master,font=("Calibri",25),bg="white",fg="black")
direction5 = Label(master,font=("Calibri",25),bg="white",fg="black")
